...
function AllOrganizations(){
    ...
    useEffect(()=>{
        ...
        const user=window.localStorage.getItem('userEmail')
          const response=await axios.get('http://localhost:4300/community')
    ...
    return(
     <>
        <div>
            <div>
                <h2 style={{display:'display', margin:'auto', width:'25%', marginTop:'20px'}}>Organizations you may know</h2>
